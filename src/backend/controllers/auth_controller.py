"""
Controller pour les endpoints d'authentification de Tsenan'tsika.
"""
...
class AuthController:
    ...
    def se_connecter(self, db: Session, email: str, mot_de_passe: str):
        """
        Endpoint de connexion qui vérifie les identifiants et retourne
        un token JWT en cas de succès.
        """
    ...
    def s_inscrire(
        ...
        """
        Endpoint d'inscription réservé aux citoyens.
        """
